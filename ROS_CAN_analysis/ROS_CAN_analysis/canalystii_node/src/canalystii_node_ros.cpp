...
void steerangle_callback(const std_msgs::Float32 &harry)
{
  ...
  if(steering_angle_control>5400)steering_angle_control=5400;
  if(steering_angle_control<-5400)steering_angle_control=-5400;
  else steering_angle_control=steering_angle_control;
...
int main(int argc, char **argv){
      ...
      std::ofstream control_speed_log("/home/adam/control_speed_log.txt", std::ios::app);
      ...
      while(ros::ok())
      {
        //if (is_send){
          ...
          if(VCI_Transmit(VCI_USBCAN2, 0, 0, send, 1) == 1)
          {
            ...
            control_speed_log << harry_speed <<std::endl;          
            ...
            send[0].Data[5]=1;
            send[0].Data[6]=1;
            send[0].Data[7]=send[0].Data[0]+send[0].Data[1]+send[0].Data[2]+send[0].Data[3]+send[0].Data[4]+send[0].Data[5]+send[0].Data[6];
            harry6=jiaoyan;
